...
## Building
To build novos, you need: sh (bash, dash, zsh, ash, ksh, etc), b3sum (for dist), Cargo, CC (clang, gcc), Rustc (rust itself!), and a POSIX-compliant system.

```sh
./build.sh build # dist for dist
```
